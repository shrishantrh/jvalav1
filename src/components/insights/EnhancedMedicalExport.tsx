  ...
  return (
    <div className="space-y-3 animate-fade-in" data-tour="exports-area">
      ...
      <Tabs
        ...
        className="w-full"
      >
        <TabsList className="grid w-full grid-cols-2 glass-card border-0 rounded-2xl p-1 h-12">
          <TabsTrigger value="share" className="h-full text-xs gap-1.5 font-semibold rounded-xl data-[state=active]:bg-primary/15 data-[state=active]:text-primary">
            <Share2 className="w-4 h-4" />
            Share Journey
          </TabsTrigger>
          <TabsTrigger value="clinical" className="h-full text-xs gap-1.5 font-semibold rounded-xl data-[state=active]:bg-primary/15 data-[state=active]:text-primary">
