...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-stretch justify-center rounded-2xl bg-white/60 backdrop-blur-[12px] p-1 text-muted-foreground/80 border border-white/20 overflow-hidden",
      className,
    )}
    {...props}
  />
