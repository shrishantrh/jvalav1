    ...
    <div className="fixed inset-0 flex flex-col bg-background max-w-md mx-auto overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative">
        ...
        <div className="flex flex-col items-center mb-8 animate-fade-in relative z-10">
          <div className="w-20 h-20 mb-5 rounded-2xl overflow-hidden shadow-lg">
            <img src={jvalaLogo} alt="Jvala" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-3xl font-bold text-foreground">Jvala</h1>
          <p className="text-sm text-muted-foreground mt-2">Track your health journey</p>
        </div>

        {/* Auth form */}
        <Card className="w-full p-6 animate-slide-up relative z-10">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            {isSignUp && (
              <div className="space-y-3 p-4 bg-muted/50 rounded-xl">
                <p className="text-xs font-semibold text-foreground">By creating an account, you agree to:</p>
        ...
        <DialogContent className="max-w-md max-h-[85vh] rounded-2xl">
          ...
          <ScrollArea className="h-[50vh] pr-4">
            <div className="text-sm space-y-5">
              ...
              <section>
                <h3 className="font-bold mb-2">2. Medical Disclaimer</h3>
                <p className="text-muted-foreground leading-relaxed">
                  <strong className="text-foreground">IMPORTANT:</strong> Jvala does not provide medical advice. Always consult with 
                  qualified healthcare professionals for medical decisions.
                </p>
              </section>
              <section>
                <h3 className="font-bold mb-2">3. AI-Generated Content</h3>
                <p className="text-muted-foreground leading-relaxed">
          ...
          <Button onClick={() => { setTermsAccepted(true); setShowTerms(false); }} className="w-full h-12 rounded-xl">
            I Accept
          </Button>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="max-w-md max-h-[85vh] rounded-2xl">
          ...
          <ScrollArea className="h-[50vh] pr-4">
            <div className="text-sm space-y-5">
              ...
              <section>
                <h3 className="font-bold mb-2">3. Your Rights</h3>
                <p className="text-muted-foreground leading-relaxed">
          ...
          <Button onClick={() => { setPrivacyAccepted(true); setShowPrivacy(false); }} className="w-full h-12 rounded-xl">
            I Accept
          </Button>
        </DialogContent>
      </Dialog>
