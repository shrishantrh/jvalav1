...
export default function ClinicianDashboard() {
  ...
  return (
    <div className="clinical-shell clinical-scroll min-h-screen">
      {/* Top bar */}
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        ...
        {patientsLoading ? (
          ...
          <Card className="p-10 text-center space-y-3 border border-border bg-card shadow-sm">
    ...
    <Card className="p-4 border border-border bg-card shadow-sm">
      <div className="flex items-center justify-between mb-1">
        <Icon className={cn(
          ...
          accent === 'warning' ? 'text-primary' :
          accent === 'ok' ? 'text-foreground' : 'text-muted-foreground'
        )} />
      </div>
...
function PatientRow({ p, onOpen }: { p: LinkedPatient; onOpen: () => void }) {
  ...
  return (
    <Card className="p-4 border border-border bg-card shadow-sm transition hover:border-primary/30 hover:bg-accent/40 cursor-pointer" onClick={onOpen}>
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-1 text-[11px] text-muted-foreground">
            ...
            {p.unread_alerts > 0 && <span className="text-primary"><Bell className="w-2.5 h-2.5 inline mr-0.5" />{p.unread_alerts}</span>}
